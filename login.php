...
<?php
if((!empty($_GET['errorMsg'])) && $_GET['errorMsg']=='invalid') {
    $errorMsg = "Invalid credentials.";
}elseif((!empty($_GET['errorMsg'])) && $_GET['errorMsg']=='access') {
    $errorMsg = "Access restricted.";
} elseif((!empty($_GET['errorMsg'])) && $_GET['errorMsg']=='reactive') {
    $errorMsg = "You are deactivated by admin."; //file_get_contents(APP_ROOT."/reactive.php");
} elseif((!empty($_GET['errorMsg'])) && $_GET['errorMsg']=='onlyAdmin') {
    $errorMsg = "Only admin can log in.";
} else {
    $errorMsg = '';
}

if((!empty($_GET['successMsg'])) && $_GET['successMsg']=='logout') {
