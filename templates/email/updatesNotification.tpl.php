...
<div style="background:#dce1e3;">
  <table bgcolor="#FFFFFF" background="<?php echo APP_FULL_URL; ?>images/email/bg.gif" width="600" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin:auto; border-bottom:2px solid #1d292c;">
 ...
 if(empty($siteView)){ ?>
      ...
      <tr>
      <td align="center"><img src="<?php echo APP_FULL_URL; ?>images/email/up_to_date.png" width="215" height="200" alt="Everything is up to date." /></td>
      </tr>
     </table>
<?php  }
else{
...
?>
  <tr>
    ...
    <?php if(!empty($showUpdate['coreUpdates']) && !empty($updateData['core'])){
		foreach($updateData['core'] as $type => $update){
		 ?>
   <tr>
    <td width="130" align="right" valign="top"><img src="<?php echo APP_FULL_URL; ?>images/email/tag_wp.png" width="77" height="17" alt="WordPress" /></td>
  ...
  ?>
   ...
   <?php if($i == 0){ ?>
     <tr>
    <td width="130" align="right" valign="top" style="padding-top:10px;"><img src="<?php echo APP_FULL_URL; ?>images/email/tag_plugins.png" width="62" height="17" alt="plugins" /></td>
    <td width="340" style="padding-top:10px;"><?php echo strip_tags($update['name']); ?></td>
  </tr>
 <?php $i = 1; } 
   else{ ?>
  <tr>
    <td align="right" valign="top">&nbsp;</td>
    <td><?php echo strip_tags($update['name']); ?></td>
  </tr><?php }
    } 
  } ?>
  ...
  <?php if($i == 0){ ?>
   <tr>
    <td width="130" align="right" valign="top" style="padding-top:10px;"><img src="<?php echo APP_FULL_URL; ?>images/email/tag_themes.png" width="62" height="17" alt="themes" /></td>
    <td width="340" style="padding-top:10px;"> <?php echo strip_tags($update['name']);  ?></td>
  </tr>
  <?php $i = 1; } 
   else{ ?>
